<!-- Split Test — asu-2-tt redirect -->
<!-- Coller dans Framer > Custom Code > Head de la page info.poppins.io/asu-2-tt -->
<style id="split-hide">body{opacity:0!important}</style>
<script>
var SPLIT_CONFIG = {
  test: "asu-2-tt",
  cookie: "split_asu_2_tt",
  variants: {
    A: "https://info.poppins.io/asu-2-tt",
    B: "https://info.poppins.io/asu-triton-classic",
    C: "https://info.poppins.io/asu-triton-story"
  }
};
</script>
<script>
