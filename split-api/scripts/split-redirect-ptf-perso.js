<!-- Split Test — ptf-perso (A: asu-2-ptf-a / B: asu-2-ptf-b) -->
<!-- Page d'entree : https://info.poppins.io/asu-2 (Custom Code > Head) -->
<!-- Lance le 2026-07-08 (officiel 50/50). Archive le 2026-08-31 depuis le Custom Code Framer. -->
<!-- Note : pas de logique VARIANT_A_URL ici, A est une page distincte de la page d'entree -->
<style id="split-hide">body{opacity:0!important}</style>
<script>
var SPLIT_CONFIG = {
  test: "ptf-perso",
  cookie: "split_ptf-perso",
  variants: {
    A: "https://info.poppins.io/asu-2-ptf-a",
    B: "https://info.poppins.io/asu-2-ptf-b"
  }
};
</script>
<script>
