<!-- Split Test — quickfix-asu-2 -->
<!-- Coller dans Framer > Page asu-2 (source) > Custom Code > Head -->
<!-- A = asu-2 (baseline, reste sur place) / B = asu-2-qf-b / C = asu-2-qf-c -->
<style id="split-hide">body{opacity:0!important}</style>
<script>
var SPLIT_CONFIG = {
  test: "quickfix-asu-2",
  cookie: "split_quickfix_asu_2",
  variants: {
    A: "https://info.poppins.io/asu-2",
    B: "https://info.poppins.io/asu-2-qf-b",
    C: "https://info.poppins.io/asu-2-qf-c"
  }
};
</script>
<script>
