<!-- Split Test — Template redirect generique -->
<!-- Copier ce bloc dans Framer > Custom Code > Head -->
<!-- Modifier UNIQUEMENT le bloc SPLIT_CONFIG pour chaque test -->
<style id="split-hide">body{opacity:0!important}</style>
<script>
var SPLIT_CONFIG = {
  test: "CHANGE_ME",
  cookie: "split_CHANGE_ME",
  variants: {
    A: "https://info.poppins.io/CHANGE_ME",
    B: "https://info.poppins.io/CHANGE_ME",
    C: "https://info.poppins.io/CHANGE_ME"
  }
};
</script>
<script>
