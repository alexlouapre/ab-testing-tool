<!-- Split Test — triton-meta redirect -->
<!-- Coller dans Framer > Page source (asu-2) > Custom Code > Head -->
<style id="split-hide">body{opacity:0!important}</style>
<script>
var SPLIT_CONFIG = {
  test: "triton-meta",
  cookie: "split_triton_meta",
  variants: {
    A: "https://info.poppins.io/asu-2",
    B: "https://info.poppins.io/asu-triton-meta-verb",
    C: "https://info.poppins.io/asu-triton-meta-story"
  }
};
</script>
<script>
