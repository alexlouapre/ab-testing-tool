<!-- Story page bridge — asu-triton-story -->
<!-- Coller dans Framer > Custom Code > Head de la page info.poppins.io/asu-triton-story -->
<!-- Gère : postMessage bridge iframe ↔ parent + sendBeacon CTA tracking -->
<script>
(function () {
  var COOKIE_NAME = "split_asu_2_tt";
  var TEST_ID = "asu-2-tt";
